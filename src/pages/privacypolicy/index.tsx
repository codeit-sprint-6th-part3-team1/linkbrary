    ...
    <>
      ...
      <div className={s.container}>
        ...
        <div className={s.content}>
          ...
          <p>
            Welcome to Linkbrary, the online and mobile service of the linkbrary_team1 at Codeit (“we,” or “us”). Our Privacy Policy explains how we collect,
            use, disclose, and protect information that applies to our Service, and your choices about the collection and use of your information.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Information we collect from third parties:</strong> We may receive information about you from third parties. For example, if you access
              our websites or Service through a third-party connection or log-in, for example, through Facebook Connect, by “following,” “liking,” adding the
          ...
          <ul>
            ...
            <li>
              <strong>To communicate with you:</strong> We may use your information to send you updates, promotional materials, and other information that may
              be of interest to you. You can opt out of receiving these communications at any time.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              (such as customer support, hosting, and analytics services). These third parties may have access to your personal information as a part of
              providing these services, but they are obligated not to disclose or use it for any other purpose.
            </li>
          </ul>
